    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link collapsed" href="<?= base_url ('home/barang')?> ">
          <i class="bi bi-menu-button-wide"></i><span>Barang</span>
        </a>
       
      </li><!-- End Components Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url ('home/barangm')?> ">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url ('home/barangk')?> ">
          <i class="bi bi-layout-text-window-reverse"></i><span>Barang Keluar</span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bx bx-user"></i><span>User</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?= base_url('home/barang/'.session()->get('id'))?>">
          <i class="bi bi-person"></i>
          <span>Barang</span>
        </a>
